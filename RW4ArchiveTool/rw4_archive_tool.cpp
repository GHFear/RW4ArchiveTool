    ...
    if (pnmh->idFrom == ID_LIST_VIEW)
    {
      ...
      case NM_DBLCLK:
        ...
        if (selectedItemIndex != -1) {
          ...
          if (successful_parse) // Update the fileview if we successfully parsed the files.
          {
